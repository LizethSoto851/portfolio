...
<template>
  ...
  <section class="min-h-screen py-10 bg-gray-100">
    <div class="max-w-4xl mx-auto px-6">
      <h1 class="text-4xl font-bold mb-8 text-center">Galería de Trabajos</h1>

     
      <div class="flex justify-center gap-4 mb-10 flex-wrap">
        <button @click="filtro='todos'" class="px-4 py-2 bg-white shadow rounded hover:scale-105 transition">Todos</button>
        <button @click="filtro='diseno'" class="px-4 py-2 bg-white shadow rounded hover:scale-105 transition">Diseño</button>
        <button @click="filtro='ilustracion'" class="px-4 py-2 bg-white shadow rounded hover:scale-105 transition">Ilustración</button>
        <button @click="filtro='pintura'" class="px-4 py-2 bg-white shadow rounded hover:scale-105 transition">Pintura</button>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
        <RouterLink
          ...
          class="relative group overflow-hidden shadow-lg block rounded-lg"
